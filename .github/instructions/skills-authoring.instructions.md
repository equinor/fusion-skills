...
- Manually edit generated release artifacts during skill create/update work:
  - root `README.md`
  - root `CHANGELOG.md`
  - any `skills/**/CHANGELOG.md`

These are generated by release automation and must only change in release flow.
