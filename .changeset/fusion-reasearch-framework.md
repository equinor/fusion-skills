---
"fusion-reasearch-framework": minor
---

Add the `fusion-reasearch-framework` skill under `skills/.system/` for source-backed Fusion Framework implementation lookup through MCP.
