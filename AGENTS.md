...
For local skill discovery in this repository, search `skills/` first and include both `skills/` and `skills/.experimental/` in local `.agents/skills` lookup paths for this workspace.
