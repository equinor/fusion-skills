...
| --- | --- | --- |
| [`fusion-github-review-resolution`](skills/.experimental/fusion-github-review-resolution/SKILL.md) | Resolve unresolved GitHub pull request review comments by researching each comment, applying fixes with validation, committing per comment, then posting fix replies and resolving threads. | `0.1.0` |
...
| [`fusion-issue-solving`](skills/.experimental/fusion-issue-solving/SKILL.md) | Solve a GitHub issue end-to-end by researching context, planning executable todos, implementing scoped changes, validating results, and preparing PR updates. | `0.1.0` |
| [`fusion-issue-task-planning`](skills/.experimental/fusion-issue-task-planning/SKILL.md) | Plan and break down user-story issues into ordered, traceable task issue drafts with explicit publish gates. | `0.1.0` |
