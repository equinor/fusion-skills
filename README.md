...
| [`fusion-issue-solving`](skills/.experimental/fusion-issue-solving/SKILL.md) | Handles GitHub issue resolution end-to-end for prompts like "solve | `0.1.3` |
